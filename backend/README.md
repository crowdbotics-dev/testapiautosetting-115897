...
## Project Structure
    ...
    ├── testapiautosetting_115897  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115897`
...
2. Clone this repo and `cd testapiautosetting_115897`
